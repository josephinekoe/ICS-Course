Dir.chdir 'C:/Users/Jo/Pictures/Folder2'
# First we find all of the pictures to be moved.
pic_names = Dir['C:/Users/Jo/Pictures/Folder1/**/*.gif']
...
if File.exist? new_name
	puts
	puts new_name + " already exists. Are you sure you want to override it? Please type \"YES\" if you want to override it, or else this program will end."
	if gets.chomp != "YES"
		exit
	end
end
